...
class IncidentsSpiderSpider(scrapy.Spider):
    name = 'present_incidents'

    def __init__(self):
        print("collecting incidents teams data :")
        self.start_urls = ['https://api.sofascore.com/api/v1/event/' + str(i) + '/incidents' for i in retrieve_matches_ids()]
    ...
    def parse(self, response):
        ...
        if mainJson is not None:
            ...
            item["incidents"] = mainJson['incidents']
            yield item
